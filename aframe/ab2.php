...
<body>
  <a-scene background="color: #ECECEC">
    ...
    <a-entity sphere-collider="objects:img;" super-hands hand-controls="hand:right;color:red;"></a-entity>
    <a-entity sphere-collider="objects:img;" super-hands hand-controls="hand:left;color:red;"></a-entity>

    <a-entity id="spots" hotspots>
      <a-entity id="group-point1">
        <a-image spot="linkto:#point10;spotgroup:group-point10" position="3 2 -2"></a-image>
      ...
      <a-entity id="group-point9" scale="0 0 0">
        ...
        <a-image spot="linkto:#point10;spotgroup:group-point10" position="1 2 7"></a-image>
      </a-entity>
      <a-entity id="group-point10" scale="0 0 0">
        <a-image spot="linkto:#point3;spotgroup:group-point3" position="5 2 -2"></a-image>
        <a-image spot="linkto:#point9;spotgroup:group-point9" position="-5 2 -2"></a-image>
      </a-entity>
    </a-entity>
    ...
    <a-entity id="cam" camera position="0 1.6 0" look-controls gamepad-controls>
      <a-entity cursor="fuse:true;fuseTimeout:1000" geometry="primitive:ring;radiusInner:0.01;radiusOuter:0.02" position="0 0 -1.8" material="shader:flat;color:#ffff00" animation__mouseenter="property:scale;to:3 3 3;startEvents:mouseenter;endEvents:mouseleave;dir:reverse;dur:2000;loop:1">
      </a-entity>
    </a-entity>
